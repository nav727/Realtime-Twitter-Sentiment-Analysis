...
def main():
    ...
    st.sidebar.info("Realtime Twitter Sentiment Analysis scrapes Twitter for topic selected by the user. The extracted tweets are then used to determine realtime sentiments about the topic. \
